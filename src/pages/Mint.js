...
function Swap() {
  ...
  const chainObj = {
    5: {
      ...
      mintContract: "0x1ceb42fc604c8607d844acbe2ab81ba3e3c80eae", //initiate mint contract
      domain: 5,
    },
    80_001: {
      chainId: 80_001,
      ...
      mintContract: "0x17E695CA08DaBa6f9b351008A2DD9D65cb8F679b", //nft mint contract
      domain: 80001,
    },
    1_287: {
      chainId: 1_287,
      ...
      mintContract: "0xa2d9bd7e1f692ab33aa1066611b99a4a4bcf83d7", //initiate mint contract
      domain: 1287,
    },
  };
    ...
    try {
      if (chain.id === 80_001) {
        const mintContract = new ethers.Contract(
          chainObj[chain.id].mintContract,
          mintnftabi,
          signer
        );
        ...
        alert.success(
          <div>
            ...
            <button
              className="text-xs"
              onClick={() =>
                window.open(chainObj[chain.id].explorer + txn.hash, "_blank")
              }
            >
              View on explorer
            </button>
        ...
        const initiateMintContract = new ethers.Contract(
          chainObj[chain.id].mintContract,
          initiatemintabi,
          signer
        );
        const txn = await initiateMintContract.initiateMint(
          chainObj[80_001].domain,
          chainObj[80_001].mintContract,
          { value: ethers.utils.parseUnits("1", "wei") }
        );
        alert.success(
          <div>
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://explorer.hyperlane.xyz/?search=" + txn.hash,
                  "_blank"
                )
              }
            >
